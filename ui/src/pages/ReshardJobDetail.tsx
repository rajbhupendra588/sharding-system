    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Resharding Job</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Shards */}
        <div className="card">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Shards</h2>
          <div className="space-y-4">
            <div>
              <dt className="text-sm font-medium text-gray-500 mb-2">Source Shards</dt>
            ...
            <div>
              <dt className="text-sm font-medium text-gray-500 mb-2">Target Shards</dt>
              <div className="space-y-1">
