...
// SwaggerInforouter holds exported Swagger Info so clients can modify it
var SwaggerInforouter = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8080",
	BasePath:         "/v1",
	Schemes:          []string{},
	...
	InfoInstanceName: "router",
	SwaggerTemplate:  docTemplaterouter,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInforouter.InstanceName(), SwaggerInforouter)
}
